...
public final class ClassRemapper extends org.objectweb.asm.commons.ClassRemapper {
    ...
    public MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
        ...
        MethodVisitor mv = this.cv.visitMethod(access, this.remapper.mapMethodName(this.className, name, desc, access), this.remapper.mapMethodDesc(desc), signature, exceptions == null ? null : this.remapper.mapTypes(exceptions));
    ...
    private MethodVisitor createMethodRemapper(MethodVisitor methodVisitor, int access) {
        return (MethodVisitor) (this.remapper.getLvtStyle() != null && this.remapper.getLvtStyle() != EnhancedMethodRemapper.LVTStyle.NONE ? new EnhancedMethodRemapper(methodVisitor, this.remapper, access) : super.createMethodRemapper(methodVisitor));
    }
